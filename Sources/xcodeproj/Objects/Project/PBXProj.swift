...
public extension PBXProj {
    ...
    public func batchUpdate(sourceRoot: Path, closure: (PBXBatchUpdater) throws -> ()) throws {
        let fileBatchUpdater = PBXBatchUpdater(projectObjects: objects, sourceRoot: sourceRoot)
