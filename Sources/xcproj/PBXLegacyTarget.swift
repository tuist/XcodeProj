...
final public class PBXLegacyTarget: PBXTarget {
    ...
    public init(reference: String,
        ...
        super.init(reference: reference, name: name, buildConfigurationList: buildConfigurationList, buildPhases: buildPhases, buildRules: buildRules, dependencies: dependencies, productName: productName, productReference: productReference, productType: productType)
    }
