...
extension PBXProj {
    ...
    @available(*, deprecated, message: "Use objects.fileElements instead") public var fileElements: [PBXFileElement] { get { return objects.fileElements.referenceValues } set(val) { objects.fileElements = Dictionary(references: val) } }
