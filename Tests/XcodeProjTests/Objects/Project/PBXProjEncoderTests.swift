...
class PBXProjEncoderTests: XCTestCase {
    ...
    func test_buildFiles_in_default_uuid_order() {
        ...
        line = lines.validate(lineContaining: "0CD815522852B99B00996250 /* SameName.h in Headers */", onLineAfter: line)
        line = lines.validate(lineContaining: "0CD8156E2852BE2F00996250 /* SameName.h in Headers */", onLineAfter: line)
    ...
    func test_file_references_in_default_uuid_order() {
        ...
        line = lines.validate(lineContaining: "0CD8154F2852B99B00996250 /* SameName.framework */", onLineAfter: line)
        line = lines.validate(lineContaining: "0CD815512852B99B00996250 /* SameName.h */", onLineAfter: line)
        line = lines.validate(lineContaining: "0CD815752852BE2F00996250 /* SameName.framework */", onLineAfter: line)
