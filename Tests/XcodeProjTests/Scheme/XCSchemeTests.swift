...
final class XCSchemeIntegrationTests: XCTestCase {
    ...
    private func assert(scheme: XCScheme) {
        ...
        XCTAssertEqual(scheme.profileAction?.askForAppToLaunch, false)
        ...
        XCTAssertEqual(scheme.launchAction?.askForAppToLaunch, false)
    ...
    private func assert(minimalScheme scheme: XCScheme) {
        ...
        XCTAssertTrue(scheme.launchAction?.askForAppToLaunch == false)
        ...
        XCTAssertTrue(scheme.profileAction?.askForAppToLaunch == false)
