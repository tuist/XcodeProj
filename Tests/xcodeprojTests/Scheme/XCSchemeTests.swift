...
final class XCSchemeIntegrationTests: XCTestCase {
    ...
    private func assert(scheme: XCScheme) {
        ...
        XCTAssertEqual(scheme.buildAction?.buildActionEntries.first?.buildableReference.blueprintIdentifier.value, "23766C111EAA3484007A9026")
        ...
        XCTAssertEqual(scheme.testAction?.testables.first?.buildableReference.blueprintIdentifier.value, "23766C251EAA3484007A9026")
        ...
        XCTAssertEqual(scheme.testAction?.macroExpansion?.blueprintIdentifier.value, "23766C111EAA3484007A9026")
        ...
        XCTAssertEqual(scheme.profileAction?.buildableProductRunnable?.buildableReference.blueprintIdentifier.value, "23766C111EAA3484007A9026")
        ...
        XCTAssertEqual(scheme.launchAction?.buildableProductRunnable?.buildableReference.blueprintIdentifier.value, "23766C111EAA3484007A9026")
        ...
        XCTAssertEqual(scheme.launchAction?.preActions.first?.environmentBuildable?.blueprintIdentifier.value, "23766C111EAA3484007A9026")
        ...
        XCTAssertEqual(scheme.launchAction?.postActions.first?.environmentBuildable?.blueprintIdentifier.value, "23766C251EAA3484007A9026")
    ...
    private func assert(minimalScheme scheme: XCScheme) {
        ...
        XCTAssertTrue(scheme.buildAction?.buildActionEntries.first?.buildFor.contains(.analyzing) == true)
        XCTAssertEqual(scheme.buildAction?.buildActionEntries.first?.buildableReference.buildableIdentifier, "primary")
        XCTAssertEqual(scheme.buildAction?.buildActionEntries.first?.buildableReference.blueprintIdentifier.value, "651BA89E1E459798004EAFE5")
